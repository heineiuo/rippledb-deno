...
import { FileHandle, Env } from "./Env.ts";
import Table from "./SSTable.ts";
...
export class TableCache {
    ...
    public async get(options: ReadOptions, fileNumber: number, fileSize: number, key: Slice, arg: unknown, // state.saver, set kNotFound if not found
    saveValue: (arg: unknown, key: Slice, value: Slice) => void): Promise<Status> {
