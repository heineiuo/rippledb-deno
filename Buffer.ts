...
export class Buffer extends Uint8Array {
    ...
    static checkBigInt(value: bigint, min: bigint, max: bigint, buf: Buffer, offset: number, byteLength: number): void {
        if (value > max || value < min) {
    ...
    static fromUnknown(value: string | Uint8Array | Buffer | ArrayBuffer | {
        length: number;
    }): Buffer {
        ...
        throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array. Received type " +
            typeof value);
    }
    // a<b: -1
    static compare(a: Buffer, b: Buffer): 0 | -1 | 1 {
        if (!Buffer.isBuffer(a) || !Buffer.isBuffer(b)) {
            throw new TypeError('The "a", "b" arguments must be one of type Buffer or Uint8Array');
        }
        if (a === b)
            return 0;
        let x = a.length;
    ...
    writeBigUInt64LE(value: bigint, offset = 0): number {
        return this.internalWriteBigUInt64LE(this, value, offset, 0n, 0xffffffffffffffffn);
    }
    private internalWriteBigUInt64LE(buf: Buffer, value: bigint, offset: number, min: bigint, max: bigint): number {
