...
export default class IteratorHelper {
    static wrap<T>(iterator: IterableIterator<T>, callback: (value: T) => void): IterableIterator<T>;
    static wrap<T>(iterator: AsyncIterableIterator<T>, callback: (value: T) => void): AsyncIterableIterator<T>;
    static wrap<T>(iterator: IterableIterator<T> | AsyncIterableIterator<T>, callback: (value: T) => void): IterableIterator<T> | AsyncIterableIterator<T> {
