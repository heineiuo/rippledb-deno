 ...
 */
import { InternalKey } from "./Format.ts";
import { CompactPointer, DeletedFile, NewFile, FileMetaData, } from "./VersionFormat.ts";
export default class VersionEdit {
    ...
    addFile(level: number, fileNum: number, fileSize: number, smallest: InternalKey, largest: InternalKey): void {
