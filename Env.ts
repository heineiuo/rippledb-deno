...
export interface FileHandle {
    ...
    readFile(options?: {
        encoding?: string | null;
        flag?: string | number;
    } | string | null): Promise<string | Uint8Array>;
    /**
     ...
     */
    write<TBuffer extends Uint8Array>(buffer: TBuffer, offset?: number | null, length?: number | null, position?: number | null): Promise<{
        bytesWritten: number;
        buffer: TBuffer;
    }>;
    /**
     ...
     */
    write(data: any, position?: number | null, encoding?: string | null): Promise<{
        bytesWritten: number;
        buffer: string;
    }>;
    /**
...
export interface Env {
    ...
    readFile(dbpath: string, options?: {
        encoding?: string;
